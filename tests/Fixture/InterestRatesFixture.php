...
/**
 * InterestRatesFixture
 */
class InterestRatesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'interest_rates_ibfk_1' => ['type' => 'foreign', 'columns' => ['loan_id'], 'references' => ['loan', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
